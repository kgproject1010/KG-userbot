    ...
    if not (t or t.isdigit()):
        ...
        try:
            ...
            try:
                ...
                return await event.edit("`ᴍᴀsᴜᴋᴀɴ ᴊᴜᴍʟᴀʜ ᴛʏᴘɪɴɢ ʏᴀɴɢ ʙᴇɴᴀʀ`")
    await event.edit(f"**ᴍᴇᴍᴜʟᴀɪ ᴘᴇɴɢᴇᴛɪᴋᴀɴ ᴘᴀʟsᴜ sᴇʟᴀᴍᴀ** `{t}` **ᴅᴇᴛɪᴋ.**")
    ...
    if not (t or t.isdigit()):
        ...
        try:
            ...
            try:
                ...
                return await event.edit("`ᴍᴀsᴜᴋᴀɴ ᴊᴜᴍʟᴀʜ ᴅᴇᴛɪᴋ ʏᴀɴɢ ʙᴇɴᴀʀ`")
    await event.edit(f"**ᴍᴇᴍᴜʟᴀɪ ʀᴇᴋᴀᴍ ᴀᴜᴅɪᴏ ᴘᴀʟsᴜ sᴇʟᴀᴍᴀ** `{t}` **ᴅᴇᴛɪᴋ.**")
    await asyncio.sleep(3)
    await event.delete()
    ...
    if not (t or t.isdigit()):
        ...
        try:
            ...
            try:
                ...
                return await event.edit("`ᴍᴀsᴜᴋᴀɴ ᴊᴜᴍʟᴀʜ ᴅᴇᴛɪᴋ ʏᴀɴɢ ʙᴇɴᴀʀ`")
    await event.edit(f"**ᴍᴇᴍᴜʟᴀɪ ʙᴇʀᴍᴀɪɴ ɢᴀᴍᴇ ᴘᴀʟsᴜ sᴇʟᴀᴍᴀ** `{t}` **ᴅᴇᴛɪᴋ.**")
    await asyncio.sleep(3)
    await event.delete()
