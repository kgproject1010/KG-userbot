...
DEF_UNAPPROVED_MSG = (
    ...
    f"__SAYA ADALAH BOT YANG MENJAGA ROOM CHAT INI MOHON JANGAN MELAKUKAN SPAM SAMPAI [8](https://telegra.ph/file/de901eba4b8f4e3438ed2.jpg) CHAT, KARNA SAYA OTOMATIS AKAN MEMBLOKIR ANDA, TUNGGU SAMPAI__ **{DEFAULTUSER}** __MENERIMA PESAN ANDA__\n\n"
    "✣ `PESAN OTOMATIS BY ⚠️ 𝙆𝙂-𝙐𝙎𝙀𝙍𝘽𝙊𝙏 ⚠️` ✣\n"
)
# =================================================================
