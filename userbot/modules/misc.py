...
async def killdabot(event):
    await event.edit( -  **Berhasil di Restart**")
    if BOTLOG:
        await event.client.send_message(
...
async def reedme(e):
    await e.edit(
        ...
        "\n✣ [Userbot Repo](https://github.com/kgproject1010/KG-userbot/blob/KG-userbot/README.md)"
...
async def repo_is_here(wannasee):
    ...
    await wannasee.edit(
        ...
        f"✣ **  :** [ s](https://t.me/KGSuperbot)\n"
        f"✣ ** :** [ s ](t.me/KGSupportgroup)\n"
        f"✣ ** :** [ s](t.me/rakasupport)\n"
        f"✣ **Owner Repo :** [](t.me/knsgnwn)\n"
        f"✣ **Repo :** [-s](https://github.com/kgproject1010/KG-userbot)\n"
    )
