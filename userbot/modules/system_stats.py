...
async def amireallyalive(alive):
    ...
    output = (
        ...
        f"┣ ✥ `Uptime   : `{uptime} \n"
        f"┗━━━━━━━━━━━━━━━━ \n"
        f"⚡️ **Repo Userbot :** [KG-Userbot](https://github.com/kgproject1010/KG-userbot) \n"
        f"⚡️ **Grup Userbot :** [KG SUPPORT](https://t.me/KGSupportgroup) \n"
        f"⚡️ **Owner :** [KG](t.me/knsgnwn) \n"
    )
    if ALIVE_LOGO:
        try:
            logo = ALIVE_LOGO
...
async def amireallyalive(alive):
    ...
    uptime = await get_readable_time((time.time() - StartTime))
    output = (
        f"**[KG-Userbot](https://github.com/kgproject1010/KG-userbot) is Up and Running.**\n\n"
        f"**{ALIVE_TEKS_CUSTOM}**\n\n"
        ...
        "    **[𝗦𝘂𝗽𝗽𝗼𝗿𝘁](https://t.me/KGSupportgroup)** | **[𝗖𝗵𝗮𝗻𝗻𝗲𝗹](https://t.me/rakasupport)** | **[𝗢𝘄𝗻𝗲𝗿](t.me/knsgnwn)**"
    )
    if ALIVE_LOGO:
        try:
            logo = ALIVE_LOGO
