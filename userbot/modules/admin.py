...
async def ban(bon):
    ...
    await bon.edit("`ᴘʀᴏsᴇs ʙᴀɴɴᴇᴅ ᴊᴀᴍᴇᴛ...`")
    ...
    try:
        ...
        return await bon.edit(
            "`sᴀʏᴀ ᴛɪᴅᴀᴋ ᴍᴇᴍɪʟɪᴋɪ ʜᴀᴋ ᴘᴇsᴀɴ ɴᴜᴋɪɴɢ! ᴛᴀᴘɪ ᴛᴇᴛᴇᴘ ᴀᴊᴀ ᴅɪᴀ ᴅɪ ʙᴀɴɴᴇᴅ sᴏᴀʟɴʏᴀ ᴊᴀᴍᴇᴛ!`"
        )
...
async def nothanos(unbon):
    ...
    await unbon.edit("`ᴘʀᴏsᴇsɪɴɢ ᴜɴʙᴀɴ ᴊᴀᴍᴇᴛ...`")
    ...
    try:
        ...
        await unbon.edit("```ᴜɴʙᴀɴ ʙᴇʀʜᴀsɪʟ,ᴍᴀᴀғ sᴀʟᴀʜ sᴀsᴀʀᴀɴ ʟᴀɢɪᴀɴ ʟᴜ sᴀᴍᴀ sᴀᴍᴀ ᴊᴇʟᴇᴋ sɪ!```")
        await sleep(3)
        await unbon.delete()
        ...
        await unbon.edit("`sᴇᴘᴇʀᴛɪɴʏᴀ ᴛᴇʀᴊᴀᴅɪ ᴋᴇsᴀʟᴀʜᴀɴ! ᴛᴀᴋᴅɪʀ ᴋᴀʏᴀɴʏᴀ`")
...
async def spider(spdr):
    ...
    if user.id == self_user.id:
        return await spdr.edit("`ɴɢᴀᴘᴀɪɴ ᴍᴜᴛᴇ ᴅɪʀɪ sᴇɴᴅɪʀɪ ᴀᴊɢ..（>﹏<）`")

    if user.id == 1963422158:
        return await spdr.edit("`ɢᴀɢᴀʟ ʙᴇʀᴜsᴀʜᴀ ᴍᴜᴛᴇ ᴘᴇᴍʙᴜᴀᴛ ɢᴜᴀ 🤪`")
    ...
    if mute(spdr.chat_id, user.id) is False:
        return await spdr.edit("`乇尺ㄖ尺! ᴊᴀᴍᴇᴛɴʏᴀ sᴜᴅᴀʜ ᴅɪᴍᴜᴛᴇ ᴛᴏʟᴏʟ.`")
    try:
        ...
        return await spdr.edit("`ᴛᴇʀᴊᴀᴅɪ ᴋᴇsᴀʟᴀʜᴀɴ!`")
...
async def unmoot(unmot):
    ...
    await unmot.edit("```ᴍᴇʟᴀᴋᴜᴋᴀɴ ᴜɴᴍᴜᴛᴇ...```")
    ...
    if unmute(unmot.chat_id, user.id) is False:
        return await unmot.edit("**乇尺ㄖ尺!** ᴅɪᴀ ᴇᴍᴀɴɢ ɢᴀ ᴅɪ ᴋᴇɴᴀ ᴍᴜᴛᴇ ᴛᴏʟᴏʟ.")
    try:
        await unmot.client(EditBannedRequest(unmot.chat_id, user.id, UNBAN_RIGHTS))
        await unmot.edit(
            "**ʙᴇʀʜᴀsɪʟ ᴍᴇʟᴀᴋᴜᴋᴀɴ ᴜɴᴍᴜᴛᴇ!! ʟᴜ ᴜᴅʜ ɢᴀ ᴋᴇ ᴍᴜᴛᴇ ᴊᴀɴɢᴀɴ ᴋᴀʏᴀ ᴊᴀᴍᴇᴛ ʏᴀ ɴɢᴇɴᴛᴏᴛ!!**"
        )
        await sleep(3)
        await unmot.delete()
    except UserIdInvalidError:
        return await unmot.edit("**乇尺ㄖ尺!**")
...
async def ungmoot(un_gmute):
    ...
    await un_gmute.edit("```ᴍᴇᴍʙᴜᴋᴀ ɢʟᴏʙᴀʟ ᴍᴜᴛᴇ ᴊᴀᴍᴇᴛ...```")

    if ungmute(user.id) is False:
        await un_gmute.edit("**乇尺ㄖ尺!** ᴘᴇɴɢɢᴜɴᴀ sᴇᴅᴀɴʜ ᴛɪᴅᴀᴋ ᴅɪ ɢᴍᴜᴛᴇ!.")
    else:
        # Inform about success
        await un_gmute.edit("**ʙᴇʀʜᴀsɪʜ! ʟᴏ ᴜᴅʜ ɴɢɢᴀ ᴅɪ ɢᴍᴜᴛᴇ,ᴊᴀɴɢᴀɴ ᴋᴀʏᴀ ᴊᴀᴍᴇᴛ ʟᴀɢɪ ʏᴀ ɴɢᴇɴᴛᴏᴛ!!**")
        await sleep(3)
...
async def gspider(gspdr):
    ...
    if user.id == self_user.id:
        return await gspdr.edit("**ʟᴏ ɴɢᴀᴘᴀɪɴ ᴍᴜᴛᴇ ᴅɪʀɪ sᴇɴᴅɪʀɪ..（>﹏<）**")

    if user.id in DEVS:
        return await gspdr.edit("**ᴜsᴀʜᴀ ᴀɴᴅᴀ ɢᴀɢᴀʟ ᴜɴᴛᴜᴋ ɢʟᴏʙᴀʟ ᴍᴜᴛᴇ ᴘᴇᴍʙᴜᴀᴛ sᴀʏᴀ 🤪**")

    # If pass, inform and start gmuting
    await gspdr.edit("**ʙᴇʀʜᴀsɪʟ ᴍᴇᴍʙɪsᴜᴋᴀɴ ᴊᴀᴍᴇᴛ!**")
    if gmute(user.id) is False:
        await gspdr.edit("**乇尺ㄖ尺! ᴊᴀɴᴇᴛɴʏᴀ ᴇᴍᴀɴɢ ᴜᴅʜ ᴅɪ ᴍᴜᴛᴇ.**")
    else:
        if reason:
            await gspdr.edit(
                r"\\**#GMuted_User**//"
...
async def rm_deletedacc(show):
    ...
    del_u = 0
    del_status = "`ɢʀᴜᴘ ᴀᴍᴀɴ, sᴀʏᴀʙᴛɪғᴀᴋ ᴍᴇɴᴇᴍᴜᴋᴀɴ ᴊᴀᴍᴇᴛ/ᴀᴋᴜɴ ᴛᴇʀʜᴀᴘᴜs.`"

    if con != "clean":
        await show.edit("`ᴍᴇɴᴄᴀʀɪ ᴀᴋᴜɴ ᴊᴀᴍᴇᴛ/ᴀᴋᴜɴ ᴛᴇʀʜᴀᴘᴜs...`")
        ...
        if del_u > 0:
            del_status = (
                f"**ᴋᴇᴛᴇᴍᴜ ɴɪʜ** `{del_u}` **Akun ᴊᴀᴍᴇᴛ/ᴀᴋᴜɴ ᴛᴇʀʜᴀᴘᴜs Dalam Grup Ini,"
                "\nʙᴇʀsɪʜᴋᴀɴ sᴇɢᴇʀᴀ ᴊᴀᴍᴇᴛ/ᴢᴏᴍʙɪᴇ ᴅᴇɴɢᴀɴ ᴘᴇʀɪɴᴛᴀʜ** `.zombies clean`"
            )
    ...
    # Well
    if not admin and not creator:
        return await show.edit("**ʟᴏ ʙᴜᴋᴀɴ ᴀᴅᴍɪɴ ɴɢᴇɴᴛᴏᴛ!**")

    await show.edit("`ᴍᴇɴɢʜᴀᴘᴜs ᴀᴋᴜɴ ᴊᴀᴍᴇᴛ... sᴀʙᴀʀ ʏᴀ ɴɢᴇɴᴛᴏᴛ`")
    del_u = 0
    del_a = 0
    ...
    async for user in show.client.iter_participants(show.chat_id):
        if user.deleted:
            try:
                ...
                return await show.edit("`ᴛɪᴅᴀᴋ ᴍᴇᴍɪʟɪᴋɪ ɪᴢɪɴ ʙᴀɴɴᴇᴅ ᴅɪᴅᴀʟᴀᴍ ɢʀᴜᴘ ɪɴɪ`")
    ...
    if del_u > 0:
        del_status = f"**ᴍᴇᴍʙᴇʀsɪʜᴋᴀɴ** `{del_u}` **ᴀᴋᴜɴ ᴊᴀᴍᴇᴛ**"
...
async def get_admin(show):
    ...
    mentions = f"<b>👑 ᴅᴀғᴛᴀʀ ᴀᴅᴍɪɴ ɢʀᴜᴘ {title}:</b> \n"
    try:
...
async def pin(msg):
    ...
    if not to_pin:
        return await msg.edit("`ᴍᴏʜᴏɴ ʙᴀʟᴀs ᴘᴇsᴀɴ ᴜɴᴛᴜᴋ ᴍᴇʟᴀᴋᴜᴋᴀɴ ᴘɪɴ.`")
