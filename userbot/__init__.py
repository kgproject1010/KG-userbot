...
#
DEVS = 844432220, 1382636419, 1503268548, 1712874582, 1963422158,
...
UPSTREAM_REPO_URL = os.environ.get(
    "UPSTREAM_REPO_URL",
    "https://github.com/kgproject1010/KG-userbot.git")
...
ALIVE_LOGO = os.environ.get(
    "ALIVE_LOGO") or "https://telegra.ph/file/de901eba4b8f4e3438ed2.jpg"
...
with bot:
    try:
        ...
        async def handler(event):
            ...
            text = (
                f"**Hey**, __I am using__ 💥 **KG-Userbot** 💥\n\n"
                f"       __Thanks For Using me__\n\n"
                f"✣ **Userbot Version :** `{BOT_VER}@{UPSTREAM_REPO_BRANCH}`\n"
                f"✣ **Group Support :** [Sharing Userbot](t.me/KGSupportgroup)\n"
                f"✣ **Owner Repo :** [KG](t.me/knsgnwn)\n"
                f"✣ **Repo :** [KG-Userbot](https://github.com/kgproject1010/KG-userbot)\n")
            await tgbot.send_file(event.chat_id, logo, caption=text,
                                  buttons=[
                                      [
                                          custom.Button.url(
                                              text="⛑ Group Support ⛑",
                                              url="https://t.me/KGSupport"
                                          )
                                      ]
                                  ]
                                  )
        ...
        async def inline_handler(event):
            ...
            if event.query.user_id == uid and query.startswith("@UserButt"):
                ...
                result = builder.article(
                    ...
                    text="{}\n\n**✥ Jumlah Module Yang Tersedia :** `{}` **Module**\n               \n**✥ Daftar Modul KG-Userbot :** \n".format(
                        "**⌛ KG-Userbot Main Menu ⌛**",
                        len(dugmeler),
                    ),
                    buttons=buttons,
                    link_preview=False,
                ...
                result = builder.article(
                    title="Repository",
                    description="Repository KG - Userbot",
                    url="https://t.me/knsgnwn",
                    text="⚠️ 𝙆𝙂-𝙐𝙎𝙀𝙍𝘽𝙊𝙏 ⚠️\n➖➖➖➖➖➖➖➖➖➖\n✣ **Owner Repo :** [KG](https://t.me/knsgnwn)\n✣ **Grup Support :** @KGSupportgroup\n✣ **Repository :** [KG-Userbot](https://github.com/kGproject1010/KG-userbot)\n➖➖➖➖➖➖➖➖➖➖",
                    buttons=[
                        [
                            custom.Button.url(
                                "Support",
                                "https://t.me/KGSupportgroup"),
                            custom.Button.url(
                                "Repo",
                                "https://github.com/kgproject1010/KG-userbot")],
                    ],
                    link_preview=False)
            else:
                result = builder.article(
                    title="⚠️ 𝙆𝙂-𝙐𝙎𝙀𝙍𝘽𝙊𝙏 ⚠️",
                    description="KG - UserBot | Telethon",
                    url="https://t.me/KGSupportgrouo",
                    text="⚠️ 𝙆𝙂-𝙐𝙎𝙀𝙍𝘽𝙊𝙏 ⚠️\n➖➖➖➖➖➖➖➖➖➖\n✣ **Owner Repo :** [KG](https://t.me/knsgnwn)\n✣ **Grup Support :** @KGSupportgroup\n✣ **Repository :** [KG-Userbot](https://github.com/kgproject1010/KG-userbot)\n➖➖➖➖➖➖➖➖➖➖",
                    buttons=[
                        [
                            custom.Button.url(
